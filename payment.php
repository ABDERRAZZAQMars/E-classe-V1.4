        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form action="addpayment.php" method="POST" style="border-radius: 10px;" class="container bg-white mx-auto">
                        <div class="p-2">
            ...
            <div class="col">
                ...
                <div class="d-flex justify-content-between mx-auto mt-3" style="width: 95%;border-bottom: 1px solid gray;">
                    ...
                    <div>
                        ...
                        <button type="button" class="btn btn-info ms-3 text-white" data-bs-toggle="modal" data-bs-target="#exampleModal">ADD NEW PAYMENT</button>
                    </div>
                </div>
